...
/**
 * Hardware wrapper to abstract motors and stuff. I recommend you use this to
 * keep yourself sane.
 */
...
=======
  /**
   * Initialize hardware wrapper. This constructor reverses motors and all that
   * for you
   *
   * @param opMode Current opmode. Used to grab the HardwareMap
   */
  public Hardware(OpMode opMode) {
    ...
    opMode.telemetry = new MultipleTelemetry(
        opMode.telemetry, FtcDashboard.getInstance().getTelemetry());
    ...
    // commented out because if encoder isn't plugged in it causes this to run
    // at full speed
     ...
     * wristR: 0.90 - 0.45
     * */
>>>>>>> 138a0e7 (Refresh freesight tuner, add an opmode for tuning,  and restore dashboard functionality.)
  ...
  /**
   * Get yaw in specified unit. Counterclockwise is positive. The zero position
   * is defined by a call to <code>resetYaw</code>
   *
...
=======
  ...
  /**
   * Get yaw in radians. Counterclockwise is positive. The zero position is
   * defined by a call to <code>resetYaw</code>.
   *
   * @return yaw in radians
   */
