    ...
    public void runOpMode(Alliance alliance) {
        ...
        switch (randomization) {
            case LEFT:
                ...
                poser.goTo(
                        Distance.inTiles(0.5).sub(Distance.inInches(1)),
            ...
            case MIDDLE:
                poser.goTo(
                        Distance.inTiles(0.5).add(Distance.inInches(7)),
                        Distance.inTiles(-1.5)
                ).run();
                break;
            case RIGHT:
        ...
        sleep(2000);
        if (alliance.isBlue()) startingPose = startingPose.flippedAcrossXAxis();
        poser.goTo(startingPose);
    }
}
